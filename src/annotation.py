...
class AnnotationUI:
    ...
    def _setup_ui(self):
        ...
        self.response_a = widgets.Textarea(disabled=True, layout=widgets.Layout(width="100%", height="150px"))
        self.response_b = widgets.Textarea(disabled=True, layout=widgets.Layout(width="100%", height="150px"))
