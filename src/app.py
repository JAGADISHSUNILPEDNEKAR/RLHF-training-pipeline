...
with gr.Blocks(theme=theme, title="RLHF Training Pipeline") as app:
    ...
    with gr.Tab("✍️ Annotation"):
        ...
        load_btn.click(start_annotation, outputs=[prompt_box, resp_a_box, resp_b_box, load_btn])
        
        btn_a.click(save_preference, inputs=[gr.State("A is Better"), prompt_box, resp_a_box, resp_b_box], outputs=[prompt_box, resp_a_box, resp_b_box])
        btn_b.click(save_preference, inputs=[gr.State("B is Better"), prompt_box, resp_a_box, resp_b_box], outputs=[prompt_box, resp_a_box, resp_b_box])
        btn_tie.click(save_preference, inputs=[gr.State("Tie"), prompt_box, resp_a_box, resp_b_box], outputs=[prompt_box, resp_a_box, resp_b_box])

    with gr.Tab("⚙️ Training"):
        gr.Markdown("### Train your model")
        gr.Markdown("Once you have collected enough preferences, you can start the training process.")
